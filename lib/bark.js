...
Bark.prototype.parse = function( inputVal ) {
  ...
  {
    console.log('parse(): The input is not digits-only. Not attempting to parse further.');
  }
 ...
 * @api public
 */
if(typeof module == 'undefined') module = {}; // Workaround in case someone includes this script without npm or similar
